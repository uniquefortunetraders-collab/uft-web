          ...
          {itemsToRender.map((service: any, index: number) => {
            ...
            return (
              <Reveal key={service.id || index} direction="up" delay={index * 0.1}>
                <Card className="h-full flex flex-col justify-between p-8 bg-white border border-emerald-100 hover:border-emerald-300 shadow-sm hover:shadow-xl transition-all duration-300 rounded-2xl group">
                  <div>
